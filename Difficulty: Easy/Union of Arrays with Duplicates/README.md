...
<pre data-copier-init="true"><span style="font-size: 14pt;"><strong>Input:</strong> a[] = [1, 2, 3, 4, 5], b[] = [1, 2, 3]
<strong>Output: </strong>5<strong>
Explanation: </strong>Union set of both the arrays will be 1, 2, 3, 4 and 5. So count is 5.
</span></pre>
<pre data-copier-init="true"><span style="font-size: 14pt;"><strong>Input: </strong>a[] =<strong> </strong>[85, 25, 1, 32, 54, 6], b[] = [85, 2] <br><strong>Output: </strong>7<strong>
Explanation: </strong>Union set of both the arrays will be 85, 25, 1, 32, 54, 6, and 2. So count is 7.</span></pre>
<pre data-copier-init="true"><span style="font-size: 14pt;"><strong>Input: </strong>a[] =<strong> </strong>[1, 2, 1, 1, 2], b[] = [2, 2, 1, 2, 1] <br><strong>Output: </strong>2<strong>
